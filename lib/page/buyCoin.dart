...
class BuyCoin extends StatefulWidget {
  ...
  @override
  _BuyCoinState createState() => new _BuyCoinState();
}
...
class _BuyCoinState extends State<BuyCoin> {
  ...
  Widget build(BuildContext context) => Scaffold(
        appBar: LedgeAppBar("${'Buy ' + widget.coin.name}"),
        body: Container(
  ...
  submit() {
    database.buyCoin(widget.coin.id, double.parse(inputController.text.trim()));
